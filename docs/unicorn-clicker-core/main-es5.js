...
var ActivitiesEngineComponent = /** @class */ (function () {
    function ActivitiesEngineComponent(activitiesService, magicEngine, gameEngine, animalEngine, animalService, route) {
    ...
    ActivitiesEngineComponent.prototype.getActivities = function () {
        var _this = this;
        this.activitiesService.getActivities()
            .subscribe(function (activities) { return _this.activities = activities; });
    };
    ActivitiesEngineComponent.prototype.getAnimals = function () {
        var _this = this;
        this.animalService.getAnimals()
            .subscribe(function (animals) { return _this.animals = animals; });
    };
    ActivitiesEngineComponent.prototype.checkActivities = function (id) {
        ...
        var currentAnimalLvl = Number(this.getCurrentAnimallvl());
        var activityLvl = this.getActivityLvl(id);
        var currentMagic = this.magicEngine.getMagic();
        var animalSpeed = Number(this.getAnimalSpeed());
        var animalBeauty = Number(this.getAnimalBeauty());
        var animalStr = Number(this.getAnimalStr());
        var animalInt = Number(this.getAnimalInt());
    ...
    ActivitiesEngineComponent.prototype.getCurrentAnimallvl = function () {
        //TODO: create a check for active animal currently there is only 1 animal
        var currentAnimal = this.id;
    ...
    ActivitiesEngineComponent.prototype.getAnimalInt = function () {
        //TODO: create a check for active animal currently there is only 1 animal
        var currentAnimal = this.id;
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id == currentAnimal) {
    ...
    ActivitiesEngineComponent.prototype.getAnimalSpeed = function () {
        //TODO: create a check for active animal currently there is only 1 animal
        var currentAnimal = this.id;
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id == currentAnimal) {
    ...
    ActivitiesEngineComponent.prototype.getAnimalStr = function () {
        var currentAnimal = this.id;
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id == currentAnimal) {
    ...
    ActivitiesEngineComponent.prototype.getAnimalBeauty = function () {
        var currentAnimal = this.id;
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id == currentAnimal) {
    ...
    ActivitiesEngineComponent.prototype.getActivitySpeed = function (id) {
        var activityArray = this.activities;
        var activitySpeed = activityArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
            return item.speed;
        });
    ...
    ActivitiesEngineComponent.prototype.getActivityLvl = function (id) {
        var activityArray = this.activities;
        var activitylvl = activityArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
            return item.lvl;
        });
    ...
    ActivitiesEngineComponent.prototype.getActivitytime = function (id) {
        var activityArray = this.activities;
        var activitylvl = activityArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
    ...
    ActivitiesEngineComponent.prototype.getActivityExp = function (id) {
        var activityArray = this.activities;
        var activityExp = activityArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
            return item.expGain;
        });
    ...
    ActivitiesEngineComponent.prototype.purchaseActivity = function (cost, id) {
        var totalMagic = document.getElementById('magicTotal').innerHTML;
        if (totalMagic >= cost) {
    ...
    ActivitiesEngineComponent.prototype.updateActivity = function (id) {
        for (var i = 0; i < this.activities.length; i++) {
    ...
    ActivitiesEngineComponent.prototype.resetActivity = function (id) {
        //TODO: create function to reset all setting back to 0
        var _this = this;
        var totalMagic = this.magicEngine.getMagic();
        for (var i = 0; i < this.activities.length; i++) {
            if (this.activities[i].id == id) {
                this.activities[i].isrunning = false;
                this.width = 0;
                var allTheMagic = (totalMagic += this.activities[i].reward);
                this.magicEngine.updateMagic(allTheMagic);
                this.updateAnimalExp(id);
                setTimeout(function () {
                    return _this.levelUpAnimal();
                }, 1500);
            }
        }
    };
    ActivitiesEngineComponent.prototype.checkClass = function (id) {
        for (var i = 0; i < this.activities.length; i++) {
            if (this.activities[i].id == id) {
    ...
    ActivitiesEngineComponent.prototype.runProgressBar = function (id) {
        var _this = this;
        var time = Number(this.getActivitytime(id));
        var countDown = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(time)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () {
            return _this.isWidthWithinLimit(id);
        }));
        countDown.subscribe(function () {
    ...
    ActivitiesEngineComponent.prototype.isWidthWithinLimit = function (id) {
        var _this = this;
        if (this.width === 100) {
            setTimeout(function () {
                return _this.resetActivity(id);
            }, 3000);
            return false;
        }
        else {
    ...
    ActivitiesEngineComponent.prototype.updateAnimalExp = function (id) {
        /**
         * This will update the animal with the bonus amount from the item you are purchasing.
         */
        var animalId = Number(document.getElementById('animal-id').innerHTML);
        var activityExp = Number(this.getActivityExp(id));
        console.log('Total Exp: ', activityExp);
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id === animalId && activityExp > 0) {
                var upgrade = (activityExp + this.animals[i].currentExperience);
                return this.animals[i].currentExperience = upgrade;
            }
        }
    };
    ActivitiesEngineComponent.prototype.levelUpAnimal = function () {
        var animalId = Number(document.getElementById('animal-id').innerHTML);
        var currentXp = Number(document.getElementById('current-xp').innerHTML);
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id === animalId && this.animals[i].experienceNeeded <= currentXp) {
                var newXp = (10 / 100) * this.animals[i].experienceNeeded;
                var upgradedXp = (this.animals[i].experienceNeeded + newXp);
                this.animals[i].lvl++;
    ...
    ActivitiesEngineComponent.prototype.ngOnInit = function () {
        this.getActivities();
        this.getAnimals();
    ...
    return ActivitiesEngineComponent;
}());
...
var AnimalEngineComponent = /** @class */ (function () {
    function AnimalEngineComponent(animalService) {
        this.animalService = animalService;
        this.animals = [];
    }
    AnimalEngineComponent.prototype.getAnimals = function () {
        var _this = this;
        this.animalService.getAnimals()
            .subscribe(function (animals) { return _this.animals = animals; });
    };
    AnimalEngineComponent.prototype.getCurrentAnimal = function () {
        //TODO: create a check for active animal currently there is only 1 animal
        var currentAnimalvl = this.animals.filter(function (item) {
            return item.lvl >= 1;
        }).map(function (item) {
            return item.name;
        });
    ...
    AnimalEngineComponent.prototype.ngOnInit = function () {
        this.getAnimals();
...
var AnimalSelectComponent = /** @class */ (function () {
    function AnimalSelectComponent(animalEngine, animalService) {
        this.animalEngine = animalEngine;
        this.animalService = animalService;
        this.animals = [];
    }
    AnimalSelectComponent.prototype.getAnimals = function () {
        var _this = this;
        this.animalService.getAnimals()
            .subscribe(function (animals) { return _this.animals = animals; });
    };
    AnimalSelectComponent.prototype.selectedAnimal = function (id) {
        for (var i = 0; i < this.animals.length; i++) {
    ...
    AnimalSelectComponent.prototype.ngOnInit = function () {
        this.getAnimals();
    };
...
var GameEngineComponent = /** @class */ (function () {
    function GameEngineComponent(magicEngine) {
        this.magicEngine = magicEngine;
        this.totalMagic = 0;
    }
    GameEngineComponent.prototype.magicTotal = function () {
        this.totalMagic = parseInt(document.getElementById('magicTotal').innerHTML);
    };
    GameEngineComponent.prototype.createAllMagic = function () {
...
var MagicCountService = /** @class */ (function () {
    function MagicCountService() {
        this.count = 0;
    }
...
var MagicEngineComponent = /** @class */ (function () {
    function MagicEngineComponent(magicCount) {
        this.magicCount = magicCount;
    }
    MagicEngineComponent.prototype.getMagic = function () {
        return this.magicCount.count;
    };
    MagicEngineComponent.prototype.createMagic = function () {
        this.magicCount.count += 1;
    };
    MagicEngineComponent.prototype.removeMagic = function (cost) {
        this.magicCount.count -= cost;
    };
    MagicEngineComponent.prototype.updateMagic = function (magic) {
        this.magicCount.count = magic;
    };
    MagicEngineComponent.prototype.ngOnInit = function () {
        this.getMagic();
    };
...
var SaveLoadComponent = /** @class */ (function () {
    function SaveLoadComponent(magicEngine, animalService, itemsService, activitiesService, route) {
        this.magicEngine = magicEngine;
        this.animalService = animalService;
    ...
    SaveLoadComponent.prototype.getAnimals = function () {
        var _this = this;
        this.animalService.getAnimals()
            .subscribe(function (animals) { return _this.animals = animals; });
    };
    SaveLoadComponent.prototype.getItems = function () {
        var _this = this;
        this.itemsService.getItems()
            .subscribe(function (items) { return _this.items = items; });
    };
    SaveLoadComponent.prototype.getActivities = function () {
        var _this = this;
        this.activitiesService.getActivities()
            .subscribe(function (activities) { return _this.activities = activities; });
    };
    SaveLoadComponent.prototype.getCurrentAnimal = function () {
        var currentAnimal = this.id;
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id == currentAnimal) {
    ...
    SaveLoadComponent.prototype.getItemsArray = function () {
    ...
    SaveLoadComponent.prototype.getActivitiesArray = function () {
        for (var i = 0; i < this.activities.length; i++) {
    ...
    SaveLoadComponent.prototype.saveGame = function () {
        var magicAmount = this.magicEngine.getMagic();
        var animals = this.getCurrentAnimal();
        var items = this.getItemsArray();
        var activities = this.getActivitiesArray();
        var save = {
            magic: magicAmount,
            animals: animals,
            items: items,
    ...
    SaveLoadComponent.prototype.loadGame = function () {
    };
    SaveLoadComponent.prototype.ngOnInit = function () {
        this.getAnimals();
        this.getItems();
        this.getActivities();
        this.id = this.route.snapshot.paramMap.get("id");
...
var WonderlandEngineComponent = /** @class */ (function () {
    function WonderlandEngineComponent(itemsService, magicEngine, animalEngine, animalService) {
        this.itemsService = itemsService;
        this.magicEngine = magicEngine;
        this.animalEngine = animalEngine;
        this.animalService = animalService;
    ...
    WonderlandEngineComponent.prototype.getItems = function () {
        var _this = this;
        this.itemsService.getItems()
            .subscribe(function (items) { return _this.items = items; });
    };
    WonderlandEngineComponent.prototype.getAnimals = function () {
        var _this = this;
        this.animalService.getAnimals()
            .subscribe(function (animals) { return _this.animals = animals; });
    };
    WonderlandEngineComponent.prototype.purchaseItem = function (cost, id) {
        var _this = this;
        var totalMagic = document.getElementById('magicTotal').innerHTML;
        if (totalMagic >= cost) {
    ...
    WonderlandEngineComponent.prototype.checkItems = function (id) {
    ...
    WonderlandEngineComponent.prototype.getCurrentAnimallvl = function () {
        //TODO: create a check for active animal currently there is only 1 animal
        var currentAnimalvl = this.animals.filter(function (item) {
            return item.lvl;
        }).map(function (item) {
    ...
    WonderlandEngineComponent.prototype.getItemLvl = function (id) {
        var itemArray = this.items;
        var itemlvl = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
            return item.lvl;
        });
    ...
    WonderlandEngineComponent.prototype.getItemStr = function (id) {
        var itemArray = this.items;
        var itemStr = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
    ...
    WonderlandEngineComponent.prototype.getItemBeauty = function (id) {
        var itemArray = this.items;
        var itemBeauty = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
    ...
    WonderlandEngineComponent.prototype.getItemSpeed = function (id) {
        var itemArray = this.items;
        var itemSpeed = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
    ...
    WonderlandEngineComponent.prototype.getitemInt = function (id) {
        var itemArray = this.items;
        var itemInt = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
    ...
    WonderlandEngineComponent.prototype.getitemExp = function (id) {
        var itemArray = this.items;
        var itemExp = itemArray.filter(function (item) {
            return item.id === id;
        }).map(function (item) {
            return item.expGain;
        });
    ...
    WonderlandEngineComponent.prototype.ngOnInit = function () {
        this.getItems();
        this.getAnimals();
    };
    WonderlandEngineComponent.prototype.updateAnimal = function (id) {
        /**
         * This will update the animal with the bonus amount from the item you are purchasing.
         */
        var animalId = Number(document.getElementById('animal-id').innerHTML);
        var itemStr = Number(this.getItemStr(id));
        var itemInt = Number(this.getitemInt(id));
        var itemSpeed = Number(this.getItemSpeed(id));
        var itemBeauty = Number(this.getItemBeauty(id));
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id === animalId && itemStr > 0) {
                var upgrade = (itemStr + this.animals[i].str);
                return this.animals[i].str = upgrade;
            }
            if (this.animals[i].id === animalId && itemInt > 0) {
                var upgrade = (itemInt + this.animals[i].intelligence);
                return this.animals[i].intelligence = upgrade;
            }
            if (this.animals[i].id === animalId && itemSpeed > 0) {
                var upgrade = (itemSpeed + this.animals[i].speed);
                return this.animals[i].speed = upgrade;
            }
            if (this.animals[i].id === animalId && itemBeauty > 0) {
                var upgrade = (itemBeauty + this.animals[i].beauty);
                return this.animals[i].beauty = upgrade;
            }
        }
    };
    WonderlandEngineComponent.prototype.updateAnimalExp = function (id) {
        /**
         * This will update the animal with the bonus amount from the item you are purchasing.
         */
        var animalId = Number(document.getElementById('animal-id').innerHTML);
        var itemExp = Number(this.getitemExp(id));
        //console.log('Total Exp: ', itemExp);
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id === animalId && itemExp > 0) {
                var upgrade = (itemExp + this.animals[i].currentExperience);
                return this.animals[i].currentExperience = upgrade;
            }
        }
    };
    WonderlandEngineComponent.prototype.levelUpAnimal = function () {
        var animalId = Number(document.getElementById('animal-id').innerHTML);
        var currentXp = Number(document.getElementById('current-xp').innerHTML);
        for (var i = 0; i < this.animals.length; i++) {
            if (this.animals[i].id === animalId && this.animals[i].experienceNeeded <= currentXp) {
    ...
    WonderlandEngineComponent.prototype.updateItem = function (id) {
        for (var i = 0; i < this.items.length; i++) {
    ...
    return WonderlandEngineComponent;
}());
